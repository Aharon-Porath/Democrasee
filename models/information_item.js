...
var InformationItem = module.exports = utils.revertibleModel(new Schema({
    ...
    image_field_preview: {type:Schema.Types.File,required:true},
    content_file: {type:Schema.Types.File},
    //tags:{type:[String], index:true},
    //users:{type:[ObjectId], ref:'User',query:common.FIND_USER_QUERY,editable:false},
    discussions:{type:ObjectId,  limit: 1000, ref:'Discussion', query:common.FIND_DISCUSSION_QUERY, index:true},
