...
<br ><br ><div class="welcome-text">\
              עיריית תל-אביב-יפו והרשות הלאומית לבטיחות בדרכים מעודדות את התנועה בעיר ברגל ובאופניים כאלטרנטיבה בריאה, ירוקה וחסכונית לשימוש ברכב. בשנים האחרונות חלה עלייה במספר רוכבי האופנייםם והאופניים החשמליים בעיר, ולא אחת, נוצרים חיכוכים בינם ובין הולכי הרגל. במקביל למאמצי העירייה להמשך סלילת שבילי אופניים ולהגברת האכיפה, אנו פונים אליכם התושבים – רוכבים, הולכי רגל ונהגים - ומזמינים אתכם ליצור יחד כללי התנהגות מוסכמים במרחב הציבורי.\
<br><br>\
...
<br><br>\
    עם הרשמתכם לאתר הנכם מאשרים את <a href="/page/terms" target="_top">תנאי השימוש</a>\
    </div></div>',
    width: '650',
