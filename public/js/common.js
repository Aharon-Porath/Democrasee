...
$(function(){
    ...
    if (!$.cookie('welcome_popup')) {
        popupProvider.showOkPopup({
            message: '<b>אבן דרך: הזמנה להשתתפות בעריכת אמנה משותפת להולכי רגל ורוכבי אופניים</b>\
<br ><br >\
...
<br><br >\
        ...
        סגנית ראש העירייה והממונה על התחבורה – הגב מיטל להבי, יפתח שוע – נציג מטעמה, יותם אביזוהר – יו"ר עמותת ישראל בשביל האופניים, חגית אוריין ועו"ד תמר יקותיאלי-עמירן, מנהלות קהילת "מחזירים את מדרכות ת"א להולכי הרגל".\
<br><br>\
